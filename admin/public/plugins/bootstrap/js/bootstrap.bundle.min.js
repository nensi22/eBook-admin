...
!function (t, e) {
      ...
      for (var i in n) {
        if (Object.prototype.hasOwnProperty.call(n, i)) {
          ...
          if (!new RegExp(o).test(a)) {
            throw new Error(
              t.toUpperCase() + ': Option "' + i + '" provided type "' + a +
                '" but expected type "' + o + '".',
            );
          }
        }
  ...
  u.jQueryDetection(),
    ...
    i.default.event.special[u.TRANSITION_END] = {
      ...
      delegateType: l,
      handle: function (t) {
        if (i.default(t.target).is(this)) {return t.handleObj.handler.apply(
            this,
            arguments,
          );}
      },
  ...
  i.default(document).on("click.bs.button.data-api", g, function (t) {
    ...
    if (
      ...
      if (
        o && (o.hasAttribute("disabled") || o.classList.contains("disabled"))
      ...
      return e.next = function () {
        ...
        e._addEventListeners = function () {
          ...
          i.default(this._element).on("keydown.bs.carousel", function (e) {
            ...
            i.default(this._element).on("mouseenter.bs.carousel", function (e) {
              return t.pause(e);
          ...
          if (
            t === C
              ...
              : (n = "carousel-item-right",
                ...
                r = "right"), f && i.default(f).hasClass(T)
          ) this._isSliding = !1;
          else if (
            !this._triggerSlideEvent(f, r).isDefaultPrevented() && s && f
          ) {
            this._isSliding = !0,
              c && this.pause(),
            ...
            } else {i.default(s).removeClass(T),
    ...
    W = function () {
      function t(t, e) {
        ...
        for (
          ...
          var r = n[i],
            ...
            s = [].slice.call(document.querySelectorAll(a)).filter(
              function (e) {
                return e === t;
              },
            );
      ...
      return e.toggle = function () {
        ...
        e.show = function () {
          var e, n, o = this;
          if (
            !(this._isTransitioning || i.default(this._element).hasClass(P) ||
              (this._parent &&
                0 ===
                  (e = [].slice.call(
                ...
                (e = null),
                e && (n = i.default(e).not(this._selector).data(j)) &&
                n._isTransitioning))
          ) {
            ...
            if (i.default(this._element).trigger(r), !r.isDefaultPrevented()) {
              ...
              i.default(this._element).removeClass(F).addClass(R),
                ...
                i.default(this._triggerArray).removeClass(H).attr(
                  "aria-expanded",
                  !0,
                ),
          ...
          if (!this._isTransitioning && i.default(this._element).hasClass(P)) {
            ...
            if (i.default(this._element).trigger(e), !e.isDefaultPrevented()) {
              ...
              this._element.style[n] =
                ...
                i.default(this._element).addClass(R).removeClass(
                  "collapse show",
                );
              ...
              if (o > 0) {
                for (var r = 0; r < o; r++) {
                  ...
                  null !== s &&
                    (i.default([].slice.call(document.querySelectorAll(s)))
                      .hasClass(P) ||
              ...
              i.default(this._element).one(u.TRANSITION_END, function () {
                t.setTransitioning(!1),
                  i.default(t._element).removeClass(R).addClass(F).trigger(
                    "hidden.bs.collapse",
                  );
              }).emulateTransitionEnd(l);
            }
        ...
        t._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              !o && r.toggle && "string" == typeof e && /show|hide/.test(e) &&
              (r.toggle = !1),
  ...
  var U = "undefined" != typeof window && "undefined" != typeof document &&
      "undefined" != typeof navigator,
    V = function () {
      for (
        var t = ["Edge", "Trident", "Firefox"], e = 0; e < t.length; e += 1
  ...
  function vt(t) {
    ...
    for (var e = t.parentElement; e && "none" === K(e, "transform");) {e =
        e.parentElement;}
      ...
      modifiers: {
          ...
          fn: function (t, e) {
            ...
            return a.forEach(function (s, l) {
              ...
              var u = t.offsets.popper,
                ...
                _ = "left" === i && h || "right" === i && p ||
                  "top" === i && m || "bottom" === i && g,
                v = -1 !== ["top", "bottom"].indexOf(i),
                b = !!e.flipVariations &&
                  (v && "start" === r && h || v && "end" === r && p ||
                    !v && "start" === r && m || !v && "end" === r && g),
                y = !!e.flipVariationsByContent &&
                  (v && "start" === r && p || v && "end" === r && h ||
                    !v && "start" === r && g || !v && "end" === r && m),
                E = b || y;
              (c || _ || E) &&
                (t.flipped = !0,
                  (c || _) && (i = a[l + 1]),
        ...
        inner: {
          ...
          fn: function (t) {
            ...
            return o[a ? "left" : "top"] = r[n] -
              (s ? o[a ? "width" : "height"] : 0),
              t.placement = Ct(e),
  ...
  var Yt = Vt,
    ...
    le = function () {
      ...
      return e.toggle = function () {
        ...
        e.show = function (e) {
          if (
            ...
            if (i.default(r).trigger(o), !o.isDefaultPrevented()) {
              if (!this._inNavbar && e) {
                if ("undefined" == typeof Yt) {throw new TypeError(
              ...
              i.default(document.body).children().on(
                "mouseover",
                null,
                i.default.noop,
              ),
                ...
                i.default(r).toggleClass(Jt).trigger(
        ...
        e.hide = function () {
          if (
            !this._element.disabled && !i.default(this._element).hasClass($t) &&
            i.default(this._menu).hasClass(Jt)
          ) {
          ...
          return this.each(function () {
            ...
            if (
              ...
              (n = new t(this, "object" == typeof e ? e : null),
                i.default(this).data(Kt, n)), "string" == typeof e
            ) {
              ...
              if (e && "click" === e.type && (l.clickEvent = e), s) {
                ...
                if (
                  ...
                  i.default(a).trigger(f),
                    ...
                    ("ontouchstart" in document.documentElement &&
                      i.default(document.body).children().off(
                        "mouseover",
                        null,
                        i.default.noop,
                      ),
                      ...
                      i.default(a).removeClass(Jt).trigger(
        ...
        t._dataApiKeydownHandler = function (e) {
          if (
            !(/input|textarea/i.test(e.target.tagName)
              ...
              : !Gt.test(e.which)) &&
            !this.disabled && !i.default(this).hasClass($t)
          ) {
  ...
  i.default(document).on(ie, oe, le._dataApiKeydownHandler).on(
    ie,
    re,
    le._dataApiKeydownHandler,
  ).on(ne + " keyup.bs.dropdown.data-api", le._clearMenus).on(
    ne,
    oe,
    function (t) {
      t.preventDefault(),
      ...
      return e.toggle = function (t) {
        ...
        e._showElement = function (t) {
          ...
          if (n) {
            ...
            i.default(this._dialog).one(u.TRANSITION_END, a)
        ...
        e._showBackdrop = function (t) {
          ...
          if (this._isShown && this._config.backdrop) {
            ...
            i.default(this._backdrop).one(u.TRANSITION_END, t)
              .emulateTransitionEnd(o);
            ...
            if (i.default(this._element).hasClass(ce)) {
              ...
              i.default(this._backdrop).one(u.TRANSITION_END, r)
        ...
        e._setScrollbar = function () {
          ...
          if (this._isBodyOverflowing) {
            ...
            i.default(e).each(function (e, n) {
              ...
              i.default(n).data("padding-right", o).css(
                "padding-right",
              ...
              i.default(n).each(function (e, n) {
                ...
                i.default(n).data("margin-right", o).css(
                  "margin-right",
                  parseFloat(r) - t._scrollbarWidth + "px",
                );
              });
            ...
            i.default(document.body).data("padding-right", o).css(
              "padding-right",
      ...
      return e.enable = function () {
        ...
        e.toggle = function (t) {
          if (this._isEnabled) {
            if (t) {
              ...
              if (
                i.default(this.getTipElement()).hasClass(Fe)
        ...
        e.dispose = function () {
          clearTimeout(this._timeout),
            ...
            i.default(this.element).closest(".modal").off(
              "hide.bs.modal",
        ...
        e.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            if (i.default(this.tip).hasClass(Pe)) {
              ...
              i.default(this.tip).one(u.TRANSITION_END, d).emulateTransitionEnd(
                c,
              );
            } else d();
          }
        ...
        e._setListeners = function () {
          ...
          this.config.trigger.split(" ").forEach(function (e) {
            ...
            i.default(this.element).closest(".modal").on(
              "hide.bs.modal",
              this._hideModalHandler,
            ),
    ...
    ln = function () {
      function t(t, e) {
        ...
        this._element = t,
          ...
          i.default(this._scrollElement).on(
            "scroll.bs.scrollspy",
            function (t) {
              return n._process(t);
            },
      ...
      return e.refresh = function () {
        ...
        e._process = function () {
          ...
          if (this._scrollHeight !== e && this.refresh(), t >= n) {
            ...
            if (
              this._activeTarget && t < this._offsets[0] && this._offsets[0] > 0
            ) return this._activeTarget = null, void this._clear();
            for (
              var o = this._offsets.length; o--;
        ...
        e._activate = function (t) {
          ...
          n.hasClass("dropdown-item")
            ...
            : (n.addClass(nn),
              ...
              n.parents(rn).prev(".nav-item").children(".nav-link").addClass(
                nn,
              )),
          ...
          return this.each(function () {
            ...
            if (
              ...
              (n = new t(this, "object" == typeof e && e),
                i.default(this).data(tn, n)), "string" == typeof e
            ) {
              if ("undefined" == typeof n[e]) {
                throw new TypeError('No method named "' + e + '"');
              }
      ...
      return e.show = function () {
        ...
        e._activate = function (t, e, n) {
          ...
          if (r && a) {
            ...
            i.default(r).removeClass(hn).one(u.TRANSITION_END, s)
              .emulateTransitionEnd(l);
          } else s();
        },
      ...
      return e.show = function () {
        ...
        if (i.default(this._element).trigger(e), !e.isDefaultPrevented()) {
          ...
          if (
            ...
            i.default(this._element).one(u.TRANSITION_END, n)
              .emulateTransitionEnd(o);
          } else n();
        }
      },
        ...
        e._close = function () {
          ...
          if (this._element.classList.remove(yn), this._config.animation) {
            ...
            i.default(this._element).one(u.TRANSITION_END, e)
              .emulateTransitionEnd(n);
          } else e();
        },
